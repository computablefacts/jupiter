...
public class AbstractStorageTest extends MiniAccumuloClusterTest {
  ...
  public void testToVisibilityLabel() {
    ...
    Assert.assertEquals("ACTORS_CHILDREN_NAME", AbstractStorage.toVisibilityLabel("actors[0]¤children[1].name"));
  }
  ...
  public void testToVisibilityLabels() {
    Assert.assertEquals(Sets.newHashSet("DATA"), AbstractStorage.toVisibilityLabels(Lists.newArrayList("data")));
  ...
  public void testCompactWithPrefixWithoutSuffix() {
    ...
    Assert.assertEquals(new Authorizations("DS1_CONTENT", "DS1_CONTENT_TEXT"), AbstractStorage.compact(
        new Authorizations("DS1_CONTENT", "DS1_CONTENT_TEXT", "DS2_CONTENT", "DS2_CONTENT_TEXT"), "ds1", null));

    Assert.assertEquals(new Authorizations(Constants.STRING_ADM, "DS2_CONTENT", "DS2_CONTENT_TEXT"),
        AbstractStorage.compact(
            new Authorizations(Constants.STRING_ADM, "DS1_CONTENT", "DS1_CONTENT_TEXT", "DS2_CONTENT",
                "DS2_CONTENT_TEXT"), "ds2", null));
  }
  ...
  public void testCompactWithoutPrefixWithSuffix() {
    ...
    Assert.assertEquals(new Authorizations("DS1_CONTENT", "DS2_CONTENT"), AbstractStorage.compact(
        new Authorizations("DS1_CONTENT", "DS1_CONTENT_TEXT", "DS2_CONTENT", "DS2_CONTENT_TEXT"), null, "CONTENT"));

    Assert.assertEquals(new Authorizations(Constants.STRING_ADM, "DS1_CONTENT", "DS2_CONTENT"), AbstractStorage.compact(
        new Authorizations(Constants.STRING_ADM, "DS1_CONTENT", "DS1_CONTENT_TEXT", "DS2_CONTENT", "DS2_CONTENT_TEXT"),
        null, "CONTENT"));
  }
  ...
  public void testCompactWithPrefixWithSuffix() {
    ...
    Assert.assertEquals(new Authorizations("DS1_CONTENT"), AbstractStorage.compact(
        new Authorizations("DS1_CONTENT", "DS1_CONTENT_TEXT", "DS2_CONTENT", "DS2_CONTENT_TEXT"), "ds1", "CONTENT"));

    Assert.assertEquals(new Authorizations(Constants.STRING_ADM, "DS1_CONTENT"), AbstractStorage.compact(
        new Authorizations(Constants.STRING_ADM, "DS1_CONTENT", "DS1_CONTENT_TEXT", "DS2_CONTENT", "DS2_CONTENT_TEXT"),
        "ds1", "CONTENT"));
  }
}
