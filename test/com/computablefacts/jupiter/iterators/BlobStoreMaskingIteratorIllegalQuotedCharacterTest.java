...
public class BlobStoreMaskingIteratorIllegalQuotedCharacterTest {
  ...
  public void testWithoutIllegalQuotedCharacterInFilteredFields() throws Exception {
    ...
    BlobStoreMaskingIterator iterator = iterator(
        new Authorizations(Constants.STRING_ADM, "DATASET_1_NAME", "DATASET_1_AGE"));
    ...
    while (iterator.hasTop()) {
      ...
      if (row.startsWith("DATASET_1")) {
        Assert.assertEquals(
            JsonCodec.asObject("{\"name\":\"John\",\"city\":\"MASKED_4e6b610487d59bc2c6ee3642e988f8e2\",\"age\":31}"),
  ...
  public void testFiltersWithIllegalQuotedCharacterInFilteredFields() throws Exception {
    ...
    BlobStoreMaskingIterator iterator = iterator(
        new Authorizations(Constants.STRING_ADM, "DATASET_1_NAME", "DATASET_1_CITY"));
